        ...
        public string SelectedPalette
        {
            ...
            set
            {
                if (this.selectedPalette != value) {
                    ...
                    Properties.Appearance.Default.selectedPalette = value;
        ...
        public Link SelectedTheme
        {
            ...
            set
            {
                if (this.selectedTheme != value) {
                    ...
                    Properties.Appearance.Default.selectedTheme = value.DisplayName;
        ...
        public string SelectedFontSize
        {
            ...
            set
            {
                if (this.selectedFontSize != value) {
                    ...
                    Properties.Appearance.Default.selectedFontSize = value;
        ...
        public Color SelectedAccentColor
        {
            ...
            set
            {
                if (this.selectedAccentColor != value) {
                    ...
                    Properties.Appearance.Default.selectedAccentColor = value.ToString();
